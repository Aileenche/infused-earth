...
public class ItemToolCORE extends Item
{
    ...
    protected EnumToolMaterialCORE toolMaterial;

    protected ItemToolCORE(int par1, float par2, EnumToolMaterialCORE par3EnumToolMaterial, Block[] par4ArrayOfBlock)
    {
        super(par1);
    ...
    {
        //if ((double)Block.blocksList[blockid].getBlockHardness(par2World, x, y, z) != 0.0D)
       // {
