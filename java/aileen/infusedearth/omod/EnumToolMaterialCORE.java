...
public enum EnumToolMaterialCORE
{
    WOOD(0, 59, 2.0F, 0.0F, 15),
    STONE(1, 131, 4.0F, 1.0F, 5),
    IRON(2, 250, 6.0F, 2.0F, 14),
    EMERALD(3, 1561, 8.0F, 3.0F, 10),
    SELENIUM(4, 5000, 35.0F, 20.0F, 22),
    ...
    private EnumToolMaterialCORE(int par3, int par4, float par5, float par6, int par7)
    {
    ...
    public int getToolCraftingMaterial()
    {
        switch (this)
        {
            ...
            case SELENIUM:return infusedearth.seleniumIngot.itemID;
