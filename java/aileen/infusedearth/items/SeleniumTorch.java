...
public class SeleniumTorch extends Block
{
    public SeleniumTorch(int par1)
    {
    ...
    public void registerIcons(IconRegister reg) {
		this.blockIcon = reg.registerIcon("infusedearth:seleniumtorch");
		infusedearth.torchFX = reg.registerIcon("infusedearth:torchParticle");
	}
    /**
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (l == 1)
        {
            ...
            Particles.FLAME.spawnParticle(par1World, d0-d4, d1+ d3, d2, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 2)
        {
            par1World.spawnParticle("smoke", d0 + d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
        ...
        else if (l == 3)
        {
            ...
            Particles.FLAME.spawnParticle(par1World, d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 4)
        {
            par1World.spawnParticle("smoke", d0, d1 + d3, d2 + d4, 0.0D, 0.0D, 0.0D);
        ...
        else
        {
            ...
            Particles.FLAME.spawnParticle(par1World, d0, d1, d2, 0.0D, 0.0D, 0.0D);
        }
    }
}
