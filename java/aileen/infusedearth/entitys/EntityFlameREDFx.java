...
public class EntityFlameREDFx extends EntityFX
{
    /** the scale of the flame FX */
    private float flameScale;

    public EntityFlameREDFx(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
